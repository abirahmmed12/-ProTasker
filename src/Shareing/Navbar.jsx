...
const Navbar = () => {
  ...
  const Navlinks = (
    <>
      ...
      <li className="text-white font-bold"><NavLink to={'/aboutus'}>About Us</NavLink></li>
    ...
    <div className="relative">
      <div className="navbar bg-base-100">
        <div className="navbar-start">
          <div
            className={`sidenav fixed h-full z-10 top-0 left-0 bg-black transition-transform transform ${isSideNavOpen ? "translate-x-0" : "-translate-x-full"
              } w-60 p-16`}
          >
            <p
        ...
        <div className="navbar-center">
          ...
          <img
            ...
            src="https://th.bing.com/th/id/OIP.GCkI4GkfTZ6q-nAn4ykOXwHaD4?rs=1&pid=ImgDetMain"
            alt=""
          />
        </div>
